...
minetest.register_tool("rainbow_ore:leggings", {
...
minetest.register_tool("rainbow_ore:boots", {
...
for _, al in ipairs(aliases) do
	minetest.register_alias("rainbow_ore:rainbow_ore_"..al, "rainbow_ore:"..al)
end
